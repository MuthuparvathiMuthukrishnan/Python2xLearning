...
class Car:
    ...
    def __init__(self):
        ...
        self._protected_var = "protected123" #protected =variable
        self.__private_var = "pass@123" #privatevariable
    ...
    def printName(self): #can be accessed the private variable onlyby using a new method that too within a class only
